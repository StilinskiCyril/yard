...
Route::post('fuel-types/load', [FuelTypeController::class, 'load'])->name('fuel-types.load');
...
Route::middleware(['auth:web'])->group(function () {
    ...
    // Company admin, company user routes
    Route::prefix('vehicles')->middleware(['role:admin|company-admin|company-user'])->group(function () {
        // Show vehicles
        Route::get('/', [VehicleController::class, 'index'])->name('vehicles.index');
        // Load vehicles
        Route::post('load', [VehicleController::class, 'load'])->name('vehicles.load');
        // Create vehicle
        Route::post('create', [VehicleController::class, 'store'])->name('vehicles.store');
        // Update vehicle
        Route::put('update', [VehicleController::class, 'update'])->name('vehicles.update');
    });
