    ...
    <Layout>
            ...
            <div class="col-lg-10 col-xl-10 col-md-10 col-sm-10 mx-auto">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-6">
                                <p class="text-left">Manage Vehicle Conditions</p>
                            </div>
                    ...
                    <div class="card-body">
                        <form>
                            <div class="form-group row">
                                <div class="col-md-4">
                                    <input v-model="filterForm.condition" type="text" class="form-control" placeholder="Enter vehicle condition">
                                </div>
                                <div class="col-md-2">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Create Vehicle Condition</h4>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form>
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                            <input v-model="createForm.condition" placeholder="Enter vehicle condition e.g. Foreign-Used" type="text" class="form-control">
                                        </div>
                                    </div>
                                </form>
                            </div>
        ...
        <div class="modal fade" id="updateRecordModal">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Update Vehicle Condition</h4>
                    </div>
                    <div class="modal-body">
                        <div class="card">
                            <div class="card-body">
                                <form>
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                            <input v-model="updateForm.condition" placeholder="Enter vehicle condition" type="text" class="form-control">
                                        </div>
                                    </div>
                                </form>
                            </div>
...
export default {
    ...
    methods: {
        loadPayloadFromApi(page = 1){
            ...
            axios.post(route('vehicle-conditions.load', {page: page}), this.filterForm).then(response => {
        ...
        createRecord(){
            ...
            axios.post(route('vehicle-conditions.store'), this.createForm).then((response) => {
                if (response.data.status){
                    this.loadPayloadFromApi();
                    this.createForm.condition = undefined;
        ...
        showUpdateRecordModal(col){
            ...
            this.updateForm.condition = col.condition;
            $('#updateRecordModal').modal('show');
        },
        updateRecord(){
            this.updateForm.processing = true;
            axios.put(route('vehicle-conditions.update', { vehicle_condition: this.updateForm.uuid}), this.updateForm).then((response) => {
                if (response.data.status){
                    this.loadPayloadFromApi();
                    this.updateForm.condition = undefined;
                    Swal.fire('Success', response.data.message, 'success');
        ...
        deleteRecord(col){
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    axios.delete(route('vehicle-conditions.destroy', {vehicle_condition: col.uuid})).then((response) => {
                        if (response.data.status){
                            this.loadPayloadFromApi();
                            Swal.fire('Success', response.data.message, 'success');
                        } else {
        ...
        clearFilter(){
            this.filterForm.condition = undefined;
            this.loadPayloadFromApi();
        }
    }
}
