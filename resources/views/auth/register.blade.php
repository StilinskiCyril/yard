                            ...
                            <div class="m-sm-4">
                                <form action="{{ route('register') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="password" class="form-control @error('password') is-invalid @enderror" type="text" name="password" value="{{ old('password') }}" required/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="password_confirmation" class="form-control @error('password_confirmation') is-invalid @enderror" type="text" name="password_confirmation" required/>
                                    </div>
                                    <div>
